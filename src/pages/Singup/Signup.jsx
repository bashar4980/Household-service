          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-3 py-2 border rounded-md   bg-gray-900   text-gray-100 focus:  border-violet-400"
                required
              />
            </div>
            ...
            <div className="space-y-2">
              <label htmlFor="picture" className="block text-sm">
                Profile picture
              </label>
              <input
                type="text"
