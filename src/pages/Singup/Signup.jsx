...
const Signup = () => {
  ...
  const githubHandeler = ()=>{
    ...
    <div className="flex justify-center space-x-4">
		<button aria-label="Log in with Google" onClick={googleHandeler} className="p-3 rounded-sm">
		...
		<button aria-label="Log in with GitHub" onClick={githubHandeler} className="p-3 rounded-sm">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
	...
	<form onSubmit={submitHandeler} action="" className="space-y-8 ng-untouched ng-pristine ng-valid">
        ...
        <div className="space-y-2">
            ...
            <div className="space-y-2">
				<label htmlFor="picture" className="block text-sm">Profile picture</label>
