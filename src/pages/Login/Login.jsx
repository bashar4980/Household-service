...
const Login = () => {
  const { providerLogin, userLogin ,loading } = useContext(AuthContext);
  ...
  const loginHandeler = (event) => {
    ...
    userLogin(email, password)
      .then((result) => {
        ...
        fetch("https://server-bashar4980.vercel.app/jwt", {
          method: "POST",
          headers: {
       ...
       >
         <div className="space-y-1 text-sm">
           ...
           <input
             ...
             className="w-full px-4 py-3 rounded-md  border-gray-700  bg-gray-900  text-gray-100 focus:"
           />
         </div>
         <div className="space-y-1 text-sm">
