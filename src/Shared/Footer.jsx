...
const Footer = () => {
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 md:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href=" /" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">Household</span>
			</a>
		</div>
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© 2022 Household Company Co. All rights reserved.</div>
</footer>
        </div>
    );
};
